...
public class Main
{
    ...
    public static void main(String[] args) {
        ...
        while (true)
        {
            ...
            String[] studentList = userInput.split("\\s");

            //If the first element in the array is "DONE", break out of the loop.
            if (studentList[0].equals("DONE"))
            {
                break;
            }
        ...
        while (!userInput.equals("quit")) {
            ...
            switch (inputArray[0]) {
                ...
                case "average":
                    if (inputArray[1].equals("score")) { //Call to method to calculate average score.
                        System.out.printf("The average score is: %.2f\n", gradebook.calculateAvg());
                    }
                    else if (inputArray[1].equals("letter")) { //Call to method to calculate average letter.
                ...
                case "median":
                    if (inputArray[1].equals("score")) { //Call to method to calculate median score.
                        System.out.printf("The median score is: %.2f", gradebook.calculateMedian());
                    }
                    else if (inputArray[1].equals("letter")) { //Call to method to calculate median letter.
                ...
                case "tab":
                    ...
                    if (inputArray[1].equals("scores")) { //Prints all students with their scores.
                        gradebook.printAllStudents();
                    }
                    else if (inputArray[1].equals("letters")) { //Prints all students with their letters.
    ...
    private static boolean isValidFirstName(String firstName)
    {
        ...
        { //For loop to go through firstName characters.
    ...
    private static boolean isValidLastName(String lastName)
    {
        ...
        { //Checks if the first character in lastName is uppercase or not.
            return false;
        }
        else if (dotCount > 1)
        { // If the dotCount is greater than one, return false.
            return false;
        }
    ...
    private static boolean isValidGrade(int grade)
    {
        ...
        { // Checks if grade is between 0 and 100 inclusive
            return true;
        }
        else
        {
